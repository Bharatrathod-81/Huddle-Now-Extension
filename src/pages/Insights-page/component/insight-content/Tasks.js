...
import { Icon, InsightWrapper, Title, TitleWrapper, TaskItem, ListItem, ContentList } from "./Insight-content.styles";

const Task = ({selectedMeeting, insightsData}) => {
                        ...
                        <ListItem key={index}>
                            ...
                            {content && 
                                <Icon>
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M18.7045 6.15347C19.034 6.4045 19.0976 6.87509 18.8466 7.20457L10.8466 17.7046C10.7154 17.8767 10.5163 17.9838 10.3003 17.9983C10.0844 18.0129 9.87271 17.9334 9.71967 17.7804L5.21967 13.2804C4.92678 12.9875 4.92678 12.5126 5.21967 12.2197C5.51256 11.9268 5.98744 11.9268 6.28033 12.2197L10.1735 16.1129L17.6534 6.29551C17.9045 5.96603 18.3751 5.90243 18.7045 6.15347Z" fill="#808080"/>
                                    </svg>
                                </Icon>
                            }
